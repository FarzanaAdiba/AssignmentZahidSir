...
string drug[100]= {"Acetaminophen","Adderall","Alprazolam","Amitriptyline","Amlodipine",
                   ...
                   "Trazodone","Valium","Wellbutrin","Xanax","Zoloft"
                  };
void input_Item()
{
    cout<<"Change Item: ";
...
void medistore()
{
    ...
    {
        cout<<endl<<"Select Your medication field:\n\n\t\t1.Current Medication     (press 1)\n\t\t2.New Medication         (press 2)\n\t\t3.formulary              (press 3)\n\n"<<endl;
        cout<<"Please! You Have Press: ";
        cin>>press;
        switch(press)
        {
        case 1:
            cout<<endl<<"Medication Your Address:\n\n\t\t1.OK      (press 1)\n\t\t2.Change  (Press 2)"<<endl<<endl;
